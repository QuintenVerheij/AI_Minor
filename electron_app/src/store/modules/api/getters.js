...
export default {
    GET_API_URL, GET_LOGIN_ENDPOINT, GET_REGISTER_EXTENSION, GET_LOGIN_EXTENSION, GET_MODEL_URL, GET_CLIENT_URL, GET_POSE_NAMES_EXTENSION, GET_ROLE_EXTENSION, GET_ROLE_ENDPOINT, GET_EXERCISE_URL
}